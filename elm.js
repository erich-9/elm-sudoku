...
Elm.MVC = Elm.MVC || {};
Elm.MVC.Widget = Elm.MVC.Widget || {};
Elm.MVC.Widget.make = function (_elm) {
   "use strict";
   _elm.MVC = _elm.MVC || {};
   _elm.MVC.Widget = _elm.MVC.Widget || {};
   if (_elm.MVC.Widget.values) return _elm.MVC.Widget.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var _op = {};
   var flatten = function (newslist) {
      return {actions: A3($List.foldr,
             function (_p0) {
                return $List.append(function (_) {
                   return _.actions;
                }(_p0));
             },
             _U.list([]),
             newslist)
             ,notifications: A3($List.foldr,
             function (_p1) {
                return $List.append(function (_) {
   ...
   var childNewsHandler = F3(function (actionTaker,
   notificationHandler,
   childNews) {
      var newsFromChild = flatten(A2($List.map,
      notificationHandler,
      childNews.notifications));
      var childActions = A2($List.map,actionTaker,childNews.actions);
      return {actions: A2($Basics._op["++"],
             childActions,
             newsFromChild.actions)
             ,notifications: newsFromChild.notifications};
   });
   var forwardToChild = F3(function (addr,
   actionTaker,
   notificationHandler) {
      return A2($Signal.forwardTo,
      addr,
      A2(childNewsHandler,actionTaker,notificationHandler));
   });
   var fromNotification = function (n) {
      return {actions: _U.list([]),notifications: _U.list([n])};
   };
   var fromAction = function (a) {
      return {actions: _U.list([a]),notifications: _U.list([])};
   };
   var News = F2(function (a,b) {
      return {actions: a,notifications: b};
   });
   return _elm.MVC.Widget.values = {_op: _op
...
Elm.Utilities.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var arrayUnsafeGet = F2(function (i,x) {
      var _p0 = A2($Array.get,i,x);
      if (_p0.ctor === "Just") {
            return _p0._0;
         } else {
            return _U.crashCase("Utilities",
            {start: {line: 176,column: 3},end: {line: 181,column: 33}},
            _p0)("out of range");
         }
   });
   var arrayZippedIndexedMap = F3(function (f,x,y) {
      var h = F2(function (i,b) {
         return A3(f,i,A2(arrayUnsafeGet,i,x),b);
      });
      var g = F2(function (i,a) {
         return A3(f,i,a,A2(arrayUnsafeGet,i,y));
      });
      return _U.cmp($Array.length(x),
      $Array.length(y)) < 1 ? A2($Array.indexedMap,
      g,
      x) : A2($Array.indexedMap,h,y);
   });
   var arrayZippedMap = function (f) {
      return arrayZippedIndexedMap($Basics.always(f));
   };
   var arrayUpdateZipped = F4(function (i,f,x,y) {
      var _p2 = {ctor: "_Tuple2"
                ,_0: A2($Array.get,i,x)
                ,_1: A2($Array.get,i,y)};
      if (_p2.ctor === "_Tuple2" && _p2._0.ctor === "Just" && _p2._1.ctor === "Just")
      {
            return A3($Array.set,i,A2(f,_p2._0._0,_p2._1._0),y);
         } else {
            return y;
         }
   });
   var arrayIndexedFoldl = F2(function (f,b) {
      return function (_p3) {
   ...
   var arrayAny = function (f) {
      return A2($Array.foldl,
      F2(function (a,b) {    return b || f(a);}),
      false);
   };
   var arrayAll = function (f) {
      return A2($Array.foldl,
      F2(function (a,b) {    return b && f(a);}),
      true);
   };
   var listGroupBy = F2(function (n,x) {
      return $List.isEmpty(x) ? _U.list([]) : A2($List._op["::"],
      A2($List.take,n,x),
      A2(listGroupBy,n,A2($List.drop,n,x)));
   });
   var mapExtractWithDefault = F3(function (b,f,ma) {
      var _p4 = A2($Maybe.map,f,ma);
   ...
   var mapWithDefault = F2(function (b,f) {
      return function (_p5) {
         return A2($Maybe.withDefault,b,A2($Maybe.map,f,_p5));
      };
   });
   var arrayUpdate = F3(function (i,f,x) {
      var g = function (a) {    return A3($Array.set,i,f(a),x);};
      return A3(mapWithDefault,x,g,A2($Array.get,i,x));
   });
   var fromRight = function (x) {
      var _p6 = x;
      if (_p6.ctor === "Right") {
   ...
   var isRight = function (_p9) {
      return $Basics.not(isLeft(_p9));
   };
   var Right = function (a) {    return {ctor: "Right",_0: a};};
   var Left = function (a) {    return {ctor: "Left",_0: a};};
   var mapToLeft = F2(function (f,x) {
      var _p10 = x;
      if (_p10.ctor === "Left") {
            return Left(f(_p10._0));
         } else {
            return Right(_p10._0);
         }
   });
   var mapToRight = F2(function (f,x) {
      var _p11 = x;
      if (_p11.ctor === "Right") {
            return Right(f(_p11._0));
         } else {
            return Left(_p11._0);
         }
   });
   ...
   return _elm.Utilities.values = {_op: _op
                                  ...
                                  ,fromRight: fromRight
                                  ,mapToLeft: mapToLeft
                                  ,mapToRight: mapToRight
                                  ,mapWithDefault: mapWithDefault
                                  ,mapExtractWithDefault: mapExtractWithDefault
                                  ,listGroupBy: listGroupBy
                                  ,arrayAll: arrayAll
                                  ,arrayAny: arrayAny
                                  ,arrayIndexedFoldl: arrayIndexedFoldl
                                  ,arrayUpdate: arrayUpdate
                                  ,arrayUpdateZipped: arrayUpdateZipped
                                  ,arrayZippedIndexedMap: arrayZippedIndexedMap
                                  ,arrayZippedMap: arrayZippedMap
                                  ,arrayUnsafeGet: arrayUnsafeGet};
};
Elm.MVC = Elm.MVC || {};
Elm.MVC.Application = Elm.MVC.Application || {};
Elm.MVC.Application.make = function (_elm) {
   "use strict";
   _elm.MVC = _elm.MVC || {};
   _elm.MVC.Application = _elm.MVC.Application || {};
   if (_elm.MVC.Application.values)
   return _elm.MVC.Application.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $MVC$Widget = Elm.MVC.Widget.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Utilities = Elm.Utilities.make(_elm);
   var _op = {};
   var updateInternal = F3(function (mwUpdate,mwActions,mwModel) {
      return A3($List.foldl,mwUpdate,mwModel,mwActions);
   });
   var mailbox = $Signal.mailbox({actions: _U.list([])
                                 ,notifications: _U.list([])});
   var events = function (externalEvents) {
      return $Signal.mergeMany(A2($List._op["::"],
      A2($Signal.map,$Utilities.Left,mailbox.signal),
      A2($List.map,$Signal.map($Utilities.Right),externalEvents)));
   };
   var initState = function (_p0) {
      var _p1 = _p0;
      var f = F2(function (event,_p2) {
         var _p3 = _p2;
         var _p6 = _p3._0;
         var _p4 = event;
         if (_p4.ctor === "Left") {
               var _p5 = _p4._0;
               return {ctor: "_Tuple2"
                      ,_0: A3(updateInternal,_p1.mwUpdate,_p5.actions,_p6)
                      ,_1: _p5.notifications};
            } else {
               return {ctor: "_Tuple2"
                      ,_0: A2(_p1.updateExternal,_p4._0,_p6)
                      ,_1: _U.list([])};
            }
      });
      return A3($Signal.foldp,
      f,
      {ctor: "_Tuple2",_0: _p1.mwInitModel,_1: _U.list([])},
      events(_p1.externalEvents));
   };
   var run = F2(function (mvc,state) {
      return A2($Signal.map,
      function (_p7) {
         return A2(mvc.mwView,mailbox.address,$Basics.fst(_p7));
      },
      state);
   });
   var MVC = F5(function (a,b,c,d,e) {
      return {mwInitModel: a
             ,mwView: b
             ,mwUpdate: c
             ,externalEvents: d
             ,updateExternal: e};
   });
   return _elm.MVC.Application.values = {_op: _op
                                        ,initState: initState
                                        ,run: run
                                        ,MVC: MVC};
};
...
Elm.Sudoku.make = function (_elm) {
   ...
   var insert = $Set.insert;
   var member = $Set.member;
   var toggle = F2(function (v,vs) {
   ...
   var toList = $Set.toList;
   var fromList = $Set.fromList;
   var allCandidates = function (n) {
      return fromList(_U.range(0,n * n - 1));
   };
   var serialize = function (s) {
      var f = function (x) {
         ...
         if (_p0.ctor === "Left") {
               ...
               return toList(_p0._0);
            }
      };
      return {n: s.n,board: A2($List.map,f,$Array.toList(s.board))};
   };
   var SerializedSudoku = F2(function (a,b) {
      return {n: a,board: b};
   });
   var applyToCell = F4(function (sudoku,f,p,a) {
      return A3($Utilities.mapWithDefault,
      a,
      function (c) {
         return A3(f,p,c,a);
      },
      A2($Array.get,p,sudoku.board));
   });
   var clusterFoldl = F4(function (sudoku,f,cluster,a) {
      return A3($Set.foldl,A2(applyToCell,sudoku,f),a,cluster);
   });
   var clustersXFoldl = F4(function (sudoku,p,f,a) {
      var clusters = A2($List.filter,
      $Set.member(p),
      sudoku.clusters);
      return A3($List.foldl,A2(clusterFoldl,sudoku,f),a,clusters);
   });
   var occursInClustersX = F3(function (sudoku,p,v) {
      var f = F3(function (_p1,c,a) {
         return A3($Utilities.mapWithDefault,
         a,
         function (w) {
            return a || _U.eq(w,v);
         },
         $Utilities.fromLeft(c));
      });
      return A4(clustersXFoldl,sudoku,p,f,false);
   });
   var clustersFoldl = F3(function (sudoku,f,a) {
      return A3($List.foldl,
      A2(clusterFoldl,sudoku,f),
      a,
      sudoku.clusters);
   });
   var toggleCandidate = F3(function (v,p,sudoku) {
      var f = function (candidates) {
         return A2(toggle,v,candidates);
      };
      return _U.update(sudoku,
      {board: A3($Utilities.arrayUpdate,
      p,
      $Utilities.mapToRight(f),
      sudoku.board)});
   });
   var setCandidates = F3(function (candidates,p,sudoku) {
      return _U.update(sudoku,
      {board: A3($Array.set,
      p,
      $Utilities.Right(candidates),
      sudoku.board)});
   });
   var setValue = F3(function (v,p,sudoku) {
      return _U.update(sudoku,
      {board: A3($Array.set,p,$Utilities.Left(v),sudoku.board)});
   });
   var init = F2(function (order,board) {
      var f = function (x) {
         f: while (true) {
            var _p2 = {ctor: "_Tuple2",_0: x * x,_1: x * x * x * x};
            var x2 = _p2._0;
            var x4 = _p2._1;
            if (_U.cmp(x4,$Array.length(board)) < 1) return {ctor: "_Tuple3"
                                                            ,_0: x
                                                            ,_1: x2
                                                            ,_2: x4}; else {
                  var _v1 = x - 1;
      ...
      var n2 = _p3._1;
      var n4 = _p3._2;
      var n2List = _U.range(0,n2 - 1);
      var n2Set = $Set.fromList(n2List);
      var make = function (cluster) {
         return A2($List.map,
         function (i) {
            return A2($Set.map,cluster(i),n2Set);
         },
         n2List);
      };
      var boxs = F2(function (b,p) {
         return ((b / n | 0) * n2 + A2($Basics._op["%"],
         b,
         n)) * n + (p / n | 0) * n2 + A2($Basics._op["%"],p,n);
      });
      var cols = F2(function (c,r) {    return r * n2 + c;});
      var rows = F2(function (r,c) {    return r * n2 + c;});
      return {n: n
             ,n2: n2
             ,n4: n4
             ,board: board
             ,clusters: $List.concat(_U.list([make(rows)
                                             ,make(cols)
                                             ,make(boxs)]))};
   });
   var deserialize = function (s) {
      var f = function (x) {
         ...
         if (_p4.ctor === "::" && _p4._1.ctor === "[]") {
               return $Utilities.Left(_p4._0);
            } else {
               return $Utilities.Right(fromList(x));
            }
      };
      return A2(init,s.n,A2($Array.map,f,$Array.fromList(s.board)));
   };
   var blankSudoku = function (n) {
      var acs = $Utilities.Right(allCandidates(n));
      return A2(init,
      n,
      A2($Array.initialize,n * n * n * n,$Basics.always(acs)));
   };
   var allFilledIn = function (sudoku) {
      return A2($Utilities.arrayAll,
      $Utilities.isLeft,
      sudoku.board);
   };
   var MultipleSolutions = function (a) {
      return {ctor: "MultipleSolutions",_0: a};
   };
   var Solution = function (a) {
      return {ctor: "Solution",_0: a};
   };
   var NoSolution = {ctor: "NoSolution"};
   var Sudoku = F5(function (a,b,c,d,e) {
      return {board: a,clusters: b,n: c,n2: d,n4: e};
   });
   return _elm.Sudoku.values = {_op: _op
                               ...
                               ,blankSudoku: blankSudoku
                               ,init: init
                               ,setValue: setValue
                               ,setCandidates: setCandidates
                               ,toggleCandidate: toggleCandidate
                               ,clustersFoldl: clustersFoldl
                               ,clustersXFoldl: clustersXFoldl
                               ,clusterFoldl: clusterFoldl
                               ,applyToCell: applyToCell
                               ,occursInClustersX: occursInClustersX
                               ,SerializedSudoku: SerializedSudoku
                               ,serialize: serialize
...
Elm.Widgets.EntryCell = Elm.Widgets.EntryCell || {};
Elm.Widgets.EntryCell.make = function (_elm) {
   "use strict";
   _elm.Widgets = _elm.Widgets || {};
   _elm.Widgets.EntryCell = _elm.Widgets.EntryCell || {};
   if (_elm.Widgets.EntryCell.values)
   return _elm.Widgets.EntryCell.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Utilities = Elm.Utilities.make(_elm);
   var _op = {};
   var update = F2(function (act,m) {
      var _p0 = act;
      if (_p0.ctor === "MarkImpossible") {
            return _U.update(m,{impossible: _p0._0});
         } else {
            return _U.update(m,{fixed: _p0._0});
         }
   });
   var init = function (_p1) {
      var _p2 = _p1;
      return {value: _p2.value,fixed: _p2.fix,impossible: false};
   };
   var InitData = F2(function (a,b) {
      return {value: a,fix: b};
   });
   var Model = F3(function (a,b,c) {
      return {value: a,fixed: b,impossible: c};
   });
   var Clicked = {ctor: "Clicked"};
   var view = F2(function (addr,m) {
      var _p3 = function () {
         var f = function (v) {
            return {ctor: "_Tuple2"
                   ,_0: "entry"
                   ,_1: _U.list([function (_p4) {
                      return $Html.text($Basics.toString(_p4));
                   }(v + 1)])};
         };
         return A3($Utilities.mapWithDefault,
         {ctor: "_Tuple2",_0: "empty",_1: _U.list([])},
         f,
         m.value);
      }();
      var entryType = _p3._0;
      var content = _p3._1;
      var classStr = function (_p5) {
         return $Html$Attributes.$class($String.concat(_p5));
      }(_U.list([entryType
                ,A3($Utilities.if$,m.fixed," fixed","")
                ,A3($Utilities.if$,m.impossible," impossible","")]));
      var attributes = _U.list([classStr
                               ,A2($Html$Events.onClick,
                               addr,
                               $MVC$Widget.fromNotification(Clicked))]);
      return A2($Html.div,attributes,content);
   });
   var SetFixed = function (a) {
      return {ctor: "SetFixed",_0: a};
   };
   var MarkImpossible = function (a) {
      return {ctor: "MarkImpossible",_0: a};
   };
   return _elm.Widgets.EntryCell.values = {_op: _op
                                          ,MarkImpossible: MarkImpossible
                                          ,SetFixed: SetFixed
                                          ,Clicked: Clicked
                                          ,Model: Model
                                          ,InitData: InitData
...
Elm.Widgets = Elm.Widgets || {};
Elm.Widgets.CandidatesCell = Elm.Widgets.CandidatesCell || {};
Elm.Widgets.CandidatesCell.make = function (_elm) {
   "use strict";
   _elm.Widgets = _elm.Widgets || {};
   _elm.Widgets.CandidatesCell = _elm.Widgets.CandidatesCell || {};
   if (_elm.Widgets.CandidatesCell.values)
   return _elm.Widgets.CandidatesCell.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Sudoku = Elm.Sudoku.make(_elm),
   $Utilities = Elm.Utilities.make(_elm),
   $Widgets$EntryCell = Elm.Widgets.EntryCell.make(_elm);
   var _op = {};
   var updateEntries = F2(function (m,f) {
      return _U.update(m,
      {entries: A2($Array.indexedMap,f,m.entries)});
   });
   var updateEntry = F3(function (m,v,f) {
      return _U.update(m,
      {entries: A3($Utilities.arrayUpdate,v,f,m.entries)});
   });
   var update = F2(function (act,m) {
      var _p0 = act;
      switch (_p0.ctor)
      {case "SetCandidates": return A2(updateEntries,
           m,
           F2(function (v,ecm) {
              return _U.update(ecm,
              {impossible: $Basics.not(A2($Sudoku.member,v,_p0._0))});
           }));
         case "ToggleEntry": return A3(updateEntry,
           m,
           _p0._0,
           function (ecm) {
              return _U.update(ecm,
              {impossible: $Basics.not(ecm.impossible)});
           });
         default: return A3(updateEntry,
           m,
           _p0._0,
           $Widgets$EntryCell.update(_p0._1));}
   });
   var init = function (_p1) {
      var _p2 = _p1;
      var _p3 = _p2.n;
      var f = function (v) {
         return {value: $Maybe.Just(v)
                ,fixed: false
                ,impossible: $Basics.not(A2($Sudoku.member,v,_p2.candidates))};
      };
      return {entries: A2($Array.initialize,_p3 * _p3,f),n: _p3};
   };
   var InitData = F2(function (a,b) {
      return {candidates: a,n: b};
   });
   var Model = F2(function (a,b) {    return {entries: a,n: b};});
   var Clicked = function (a) {
      return {ctor: "Clicked",_0: a};
   };
   var entryNotificationHandler = F2(function (v,ntf) {
      var _p4 = ntf;
      return $MVC$Widget.fromNotification(Clicked(v));
   });
   var UpdateEntry = F2(function (a,b) {
      return {ctor: "UpdateEntry",_0: a,_1: b};
   });
   var viewEntry = F2(function (addr,_p5) {
      var _p6 = _p5;
      var _p7 = _p6._0;
      var childAddr = A3($MVC$Widget.forwardToChild,
      addr,
      UpdateEntry(_p7),
      entryNotificationHandler(_p7));
      return A2($Html.td,
      _U.list([]),
      _U.list([A2($Widgets$EntryCell.view,childAddr,_p6._1)]));
   });
   var view = F2(function (addr,m) {
      var groupedEntries = A2($Utilities.listGroupBy,
      m.n,
      $Array.toIndexedList(m.entries));
      var row = function (r) {
         return A2($Html.tr,
         _U.list([]),
         A2($List.map,viewEntry(addr),r));
      };
      return A2($Html.table,
      _U.list([]),
      A2($List.map,row,groupedEntries));
   });
   var ToggleEntry = function (a) {
      return {ctor: "ToggleEntry",_0: a};
   };
   var SetCandidates = function (a) {
      return {ctor: "SetCandidates",_0: a};
   };
   return _elm.Widgets.CandidatesCell.values = {_op: _op
                                               ,SetCandidates: SetCandidates
                                               ...
                                               ,entryNotificationHandler: entryNotificationHandler};
};
Elm.Widgets = Elm.Widgets || {};
Elm.Widgets.SudokuCell = Elm.Widgets.SudokuCell || {};
Elm.Widgets.SudokuCell.make = function (_elm) {
   "use strict";
   _elm.Widgets = _elm.Widgets || {};
   _elm.Widgets.SudokuCell = _elm.Widgets.SudokuCell || {};
   if (_elm.Widgets.SudokuCell.values)
   return _elm.Widgets.SudokuCell.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Sudoku = Elm.Sudoku.make(_elm),
   $Utilities = Elm.Utilities.make(_elm),
   $Widgets$CandidatesCell = Elm.Widgets.CandidatesCell.make(_elm),
   $Widgets$EntryCell = Elm.Widgets.EntryCell.make(_elm);
   var _op = {};
   var isUnfixed = function (m) {
      var _p0 = m;
      if (_p0.ctor === "ECModel") {
            var _p1 = _p0._0;
            return !_U.eq(_p1.value,
            $Maybe.Nothing) && $Basics.not(_p1.fixed);
         } else {
            return false;
         }
   };
   var isFixed = function (m) {
      var _p2 = m;
      if (_p2.ctor === "ECModel") {
            return _p2._0.fixed;
         } else {
   ...
   var InitData = F4(function (a,b,c,d) {
      return {cell: a,n: b,fixNonEmpty: c,showCandidates: d};
   });
   var CCModel = function (a) {
      return {ctor: "CCModel",_0: a};
   };
   var ECModel = function (a) {
      return {ctor: "ECModel",_0: a};
   };
   var init = function (_p3) {
      var _p4 = _p3;
      var _p5 = _p4.cell;
      if (_p5.ctor === "Left") {
            return function (_p6) {
               return ECModel($Widgets$EntryCell.init(_p6));
            }({value: $Maybe.Just(_p5._0),fix: _p4.fixNonEmpty});
         } else {
            return _p4.showCandidates ? function (_p7) {
               return CCModel($Widgets$CandidatesCell.init(_p7));
            }({candidates: _p5._0,n: _p4.n}) : function (_p8) {
               return ECModel($Widgets$EntryCell.init(_p8));
            }({value: $Maybe.Nothing,fix: false});
         }
   };
   var tryToInitWithCandidateCell = F3(function (cell,
   n,
   showCandidates) {
   ...
   var initWithNonFixedEntryCell = function (cell) {
      return function (_p9) {
         return ECModel($Widgets$EntryCell.init(_p9));
      }({value: $Utilities.fromLeft(cell),fix: false});
   };
   var update = F2(function (act,model) {
      var _p10 = {ctor: "_Tuple2",_0: act,_1: model};
      _v4_4: do {
         if (_p10.ctor === "_Tuple2") {
               if (_p10._1.ctor === "CCModel") {
                     switch (_p10._0.ctor)
                     {case "CCAction":
                        return CCModel(A2($Widgets$CandidatesCell.update,
                          _p10._0._0,
                          _p10._1._0));
                        case "SetCandidates":
                        return CCModel(A2($Widgets$CandidatesCell.update,
                          $Widgets$CandidatesCell.SetCandidates(_p10._0._0),
                          _p10._1._0));
                        default: break _v4_4;}
                  } else {
                     switch (_p10._0.ctor)
                     {case "ECAction": return ECModel(A2($Widgets$EntryCell.update,
                          _p10._0._0,
                          _p10._1._0));
                        case "SetCandidates": var _p11 = _p10._1._0;
                          var f = function (v) {
                             return $Basics.not(A2($Sudoku.member,v,_p10._0._0));
                          };
                          return ECModel(_U.update(_p11,
                          {impossible: A3($Utilities.mapWithDefault,
                          false,
                          f,
                          _p11.value)}));
                        default: break _v4_4;}
   ...
   var CCNotification = function (a) {
      return {ctor: "CCNotification",_0: a};
   };
   var ECNotification = function (a) {
      return {ctor: "ECNotification",_0: a};
   };
   var SetCandidates = function (a) {
      return {ctor: "SetCandidates",_0: a};
   };
   var CCAction = function (a) {
      return {ctor: "CCAction",_0: a};
   };
   var ECAction = function (a) {
      return {ctor: "ECAction",_0: a};
   };
   var view = F2(function (addr,m) {
      var _p12 = m;
      if (_p12.ctor === "ECModel") {
            var childAddr = A3($MVC$Widget.forwardToChild,
            addr,
            ECAction,
            function (_p13) {
               return $MVC$Widget.fromNotification(ECNotification(_p13));
            });
            return A2($Widgets$EntryCell.view,childAddr,_p12._0);
         } else {
            var childAddr = A3($MVC$Widget.forwardToChild,
            addr,
            CCAction,
            function (_p14) {
               return $MVC$Widget.fromNotification(CCNotification(_p14));
            });
            return A2($Widgets$CandidatesCell.view,childAddr,_p12._0);
         }
   });
   return _elm.Widgets.SudokuCell.values = {_op: _op
                                           ,ECAction: ECAction
                                           ,CCAction: CCAction
                                           ,SetCandidates: SetCandidates
                                           ...
                                           ,InitData: InitData
                                           ,init: init
                                           ,initWithNonFixedEntryCell: initWithNonFixedEntryCell
                                           ,tryToInitWithCandidateCell: tryToInitWithCandidateCell
                                           ,isFixed: isFixed
                                           ,isUnfixed: isUnfixed
                                           ,view: view
                                           ,update: update};
...
Elm.Widgets = Elm.Widgets || {};
Elm.Widgets.SudokuGame = Elm.Widgets.SudokuGame || {};
Elm.Widgets.SudokuGame.make = function (_elm) {
   "use strict";
   _elm.Widgets = _elm.Widgets || {};
   _elm.Widgets.SudokuGame = _elm.Widgets.SudokuGame || {};
   if (_elm.Widgets.SudokuGame.values)
   return _elm.Widgets.SudokuGame.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Widgets$CandidatesCell = Elm.Widgets.CandidatesCell.make(_elm),
   $Widgets$EntryCell = Elm.Widgets.EntryCell.make(_elm),
   $Widgets$SudokuCell = Elm.Widgets.SudokuCell.make(_elm);
   var _op = {};
   var candidateUpdate = F4(function (f,p,c,pm) {
      var sc$ = function (vs) {
         return $Widgets$SudokuCell.update($Widgets$SudokuCell.CCAction($Widgets$CandidatesCell.SetCandidates(vs)));
      };
      var g = function (vs) {
         var vs$ = f(vs);
         return _U.update(pm,
         {sudoku: A3($Sudoku.setCandidates,vs$,p,pm.sudoku)
         ,cells: A3($Utilities.arrayUpdate,p,sc$(vs$),pm.cells)});
      };
      return A3($Utilities.mapWithDefault,
      pm,
      g,
      $Utilities.fromRight(c));
   });
   var clustersXFoldl = F3(function (p,f,pm) {
      return A4($Sudoku.clustersXFoldl,pm.sudoku,p,f,pm);
   });
   var simpleElimination = function (pm) {
      var rm = F3(function (p,pm,v) {
         return A3(clustersXFoldl,
         p,
         candidateUpdate($Sudoku.remove(v)),
         pm);
      });
      var f = F3(function (p,c,pm) {
         return A3($Utilities.mapWithDefault,
         pm,
         A2(rm,p,pm),
         $Utilities.fromLeft(c));
      });
      return A3($Utilities.arrayIndexedFoldl,f,pm,pm.sudoku.board);
   };
   var initWithSolution = F2(function (m,solution) {
      var f = F2(function (c,sc) {
         var _p0 = {ctor: "_Tuple2",_0: c,_1: sc};
         if (_p0.ctor === "_Tuple2" && _p0._0.ctor === "Left") {
               if (_p0._1.ctor === "ECModel") {
                     return $Widgets$SudokuCell.ECModel(_U.update(_p0._1._0,
                     {value: $Maybe.Just(_p0._0._0)}));
                  } else {
                     return function (_p1) {
                        return $Widgets$SudokuCell.ECModel($Widgets$EntryCell.init(_p1));
                     }({value: $Maybe.Just(_p0._0._0),fix: false});
                  }
            } else {
               return sc;
            }
      ...
      return {sudoku: solution
             ,cells: A3($Utilities.arrayZippedMap,f,solution.board,m.cells)};
   });
   var tidyUp = function (m) {
      return _U.update(m,
      {selected: $Maybe.Nothing,statusMessage: ""});
   };
   var markCheated = function (m) {
      return _U.update(m,{cheated: true});
   };
   var markClean = function (m) {
      return _U.update(m,{clean: true});
   };
   var updateStatusMessage = F2(function (msg,m) {
      return _U.update(m,{statusMessage: msg});
   });
   var updateCellsZipped = F2(function (m,f) {
      return _U.update(m,
      {cells: A3($Utilities.arrayZippedIndexedMap,
      f,
      m.sudoku.board,
      m.cells)});
   });
   var reinitCells = function (m) {
      var g = function (c) {
         return m.showCandidates ? A3($Widgets$SudokuCell.tryToInitWithCandidateCell,
         c,
         m.sudoku.n,
         m.showCandidates) : $Widgets$SudokuCell.initWithNonFixedEntryCell(c);
      };
      var f = F3(function (_p2,c,sc) {
         return A3($Utilities.if$,$Utilities.isRight(c),g(c),sc);
      });
      return A2(updateCellsZipped,m,f);
   };
   var tidyUpdate = function (m) {
      return function (_p3) {
         return reinitCells(tidyUp(_p3));
      }(m);
   };
   var updateCellZipped = F3(function (m,p,f) {
      return _U.update(m,
      {cells: A4($Utilities.arrayUpdateZipped,
      p,
      f,
      m.sudoku.board,
      m.cells)});
   });
   var updateCells = F2(function (m,f) {
      return _U.update(m,{cells: A2($Array.indexedMap,f,m.cells)});
   });
   var updateCell = F3(function (m,p,f) {
      return _U.update(m,
      {cells: A3($Utilities.arrayUpdate,p,f,m.cells)});
   });
   var initPremodel = function (_p4) {
      var _p5 = _p4;
      var _p7 = _p5.sudoku;
      var sc = function (cell) {
         return $Widgets$SudokuCell.init({cell: cell
                                         ,n: _p7.n
                                         ,fixNonEmpty: _p5.fixInitialNonEmptyEntries
                                         ,showCandidates: _p5.showCandidates});
      };
      var cells = A3($Array.foldl,
      function (_p6) {
         return $Array.push(sc(_p6));
      },
      $Array.empty,
      _p7.board);
      return simpleElimination({sudoku: _p7,cells: cells});
   };
   var init = function (initData) {
      var pm = initPremodel(initData);
      return {sudoku: pm.sudoku
             ,cells: pm.cells
             ,predecessor: $Maybe.Nothing
             ,successor: $Maybe.Nothing
   ...
   var InitData = F3(function (a,b,c) {
      return {sudoku: a
             ,fixInitialNonEmptyEntries: b
             ,showCandidates: c};
   });
   var toPremodel = function (m) {
      return {sudoku: m.sudoku,cells: m.cells};
   };
   var HistoricModel = function (a) {
      return {ctor: "HistoricModel",_0: a};
   };
   var toHistoricModel = function (m) {
      return HistoricModel({sudoku: m.sudoku
                           ,cells: m.cells
   ...
   var makeHistory = F2(function (present,future) {
      if (!_U.eq(future,toPremodel(present))) {
            var m = _U.update(present,
            {cheated: present.cheated || $Sudoku.allFilledIn(present.sudoku)});
            return tidyUpdate(_U.update(m,
            {sudoku: future.sudoku
            ,cells: future.cells
            ,predecessor: $Maybe.Just(toHistoricModel(m))
            ,successor: $Maybe.Nothing
            ,isProgenitor: false
            ,clean: false}));
         } else return present;
   });
   var toFuture = function (present) {
      var f = function (_p8) {
         var _p9 = _p8;
         var _p10 = _p9._0;
         return _U.update(present,
         {sudoku: _p10.sudoku
         ,cells: _p10.cells
         ,predecessor: $Maybe.Just(toHistoricModel(present))
         ,successor: _p10.successor
         ,isProgenitor: _p10.isProgenitor
         ,clean: _p10.clean
         ,cheated: _p10.isProgenitor ? _p10.cheated : present.cheated || _p10.cheated});
      };
      return A2($Maybe.map,
      function (_p11) {
         return tidyUpdate(f(_p11));
      },
      present.successor);
   };
   var toPast = function (present) {
      var f = function (_p12) {
         var _p13 = _p12;
         var _p14 = _p13._0;
         return _U.update(present,
         {sudoku: _p14.sudoku
         ,cells: _p14.cells
         ,predecessor: _p14.predecessor
         ,successor: $Maybe.Just(toHistoricModel(present))
         ,isProgenitor: _p14.isProgenitor
         ,clean: _p14.clean
         ,cheated: present.isProgenitor ? _p14.cheated : present.cheated || $Sudoku.allFilledIn(present.sudoku)});
      };
      return A2($Maybe.map,
      function (_p15) {
         return tidyUpdate(f(_p15));
      },
      present.predecessor);
   };
   var wipeSlateClean = function (present) {
      var f = function (_p16) {
         var _p17 = _p16;
         var _p18 = _p17._0;
         return _p18.clean ? $Maybe.Just(_U.update(present,
         {sudoku: _p18.sudoku
         ,cells: _p18.cells
         ,predecessor: $Maybe.Just(toHistoricModel(present))
         ,successor: $Maybe.Nothing
         ,clean: true
         ,cheated: present.cheated || $Sudoku.allFilledIn(present.sudoku)})) : A2($Maybe.andThen,
         _p18.predecessor,
         f);
      };
      var mm$ = A2($Maybe.map,
      tidyUpdate,
      A2($Maybe.andThen,present.predecessor,f));
      return A3($Utilities.if$,
      present.clean,
      $Maybe.Just(present),
      mm$);
   };
   var RequestSolution = {ctor: "RequestSolution"};
   var RequestNew = {ctor: "RequestNew"};
   var UpdateCell = F2(function (a,b) {
      return {ctor: "UpdateCell",_0: a,_1: b};
   });
   var ToggleCandidate = F2(function (a,b) {
      return {ctor: "ToggleCandidate",_0: a,_1: b};
   });
   var SetValue = F2(function (a,b) {
      return {ctor: "SetValue",_0: a,_1: b};
   });
   var SetUnknown = function (a) {
      return {ctor: "SetUnknown",_0: a};
   };
   var HandleCandidateClick = F2(function (a,b) {
      return {ctor: "HandleCandidateClick",_0: a,_1: b};
   });
   var HandleEntryClick = function (a) {
      return {ctor: "HandleEntryClick",_0: a};
   };
   var cellNotificationHandler = F2(function (p,ntf) {
      var _p19 = ntf;
      if (_p19.ctor === "ECNotification") {
            return $MVC$Widget.fromAction(HandleEntryClick(p));
         } else {
            return $MVC$Widget.fromAction(A2(HandleCandidateClick,
            _p19._0._0,
            p));
         }
   });
   var viewCell = F2(function (addr,_p20) {
      var _p21 = _p20;
      var _p22 = _p21._0;
      var childAddr = A3($MVC$Widget.forwardToChild,
      addr,
      UpdateCell(_p22),
      cellNotificationHandler(_p22));
      return A2($Html.td,
      _U.list([$Html$Attributes.$class("cell")]),
      _U.list([A2($Html.div,
      _U.list([]),
      _U.list([A2($Widgets$SudokuCell.view,childAddr,_p21._1)]))]));
   });
   var ShowCandidates = function (a) {
      return {ctor: "ShowCandidates",_0: a};
   };
   var Redo = {ctor: "Redo"};
   var Undo = {ctor: "Undo"};
   ...
   var view = F2(function (addr,m) {
      var complete = $Sudoku.allFilledIn(m.sudoku);
      var mainClass = _U.list([$Html$Attributes.$class(A3($Utilities.if$,
      $Basics.not(m.cheated) && complete,
      "solved",
      ""))]);
      var msg = complete && $String.isEmpty(m.statusMessage) ? A3($Utilities.if$,
      m.cheated,
      "",
      "Congratulations.") : m.statusMessage;
      var status = A2($Html.p,
      _U.list([$Html$Attributes.id("status")]),
      _U.list([$Html.text(msg)]));
      var solutionBtn = A2($Html.button,
      _U.list([$Html$Attributes.$class("button big danger")
              ,$Basics.not(complete) ? A2($Html$Events.onClick,
              addr,
              $MVC$Widget.fromNotification(RequestSolution)) : $Html$Attributes.disabled(true)]),
      _U.list([$Html.text("Solution")]));
      var showCandidatesBtn = A2($Html.button,
      _U.list([$Html$Attributes.$class("button huge")
              ,A2($Html$Events.onClick,
              addr,
              $MVC$Widget.fromAction(ShowCandidates($Basics.not(m.showCandidates))))]),
      _U.list([$Html.text(A3($Utilities.if$,
      m.showCandidates,
      "Hide Candidates",
      "Edit Candidates"))]));
      var redoBtn = A2($Html.button,
      _U.list([$Html$Attributes.$class("button")
              ,!_U.eq(m.successor,$Maybe.Nothing) ? A2($Html$Events.onClick,
              addr,
              $MVC$Widget.fromAction(Redo)) : $Html$Attributes.disabled(true)]),
      _U.list([$Html.text("Redo")]));
      var undoBtn = A2($Html.button,
      _U.list([$Html$Attributes.$class("button")
              ,!_U.eq(m.predecessor,$Maybe.Nothing) ? A2($Html$Events.onClick,
              addr,
              $MVC$Widget.fromAction(Undo)) : $Html$Attributes.disabled(true)]),
      _U.list([$Html.text("Undo")]));
      var resetBtn = A2($Html.button,
      _U.list([$Html$Attributes.$class("button")
              ,$Basics.not(m.clean) ? A2($Html$Events.onClick,
              addr,
              $MVC$Widget.fromAction(Reset)) : $Html$Attributes.disabled(true)]),
      _U.list([$Html.text("Reset")]));
      var fixBtn = A2($Html.button,
      _U.list([$Html$Attributes.$class("button")
              ,$Basics.not(m.clean) ? A2($Html$Events.onClick,
              addr,
              $MVC$Widget.fromAction(Fix)) : $Html$Attributes.disabled(true)]),
      _U.list([$Html.text("Fix")]));
      var clearBtn = A2($Html.button,
      _U.list([$Html$Attributes.$class("button")
              ,A2($Html$Events.onClick,addr,$MVC$Widget.fromAction(Clear))]),
      _U.list([$Html.text("Clear")]));
      var newBtn = A2($Html.button,
      _U.list([$Html$Attributes.$class("button")
              ,A2($Html$Events.onClick,
              addr,
              $MVC$Widget.fromNotification(RequestNew))]),
      _U.list([$Html.text("New")]));
      var toolbox = A2($Html.div,
      _U.list([$Html$Attributes.id("toolbox")
      ...
      _U.list([newBtn
              ...
              ,showCandidatesBtn
              ,solutionBtn]));
      var cgroup = A2($Html.colgroup,
      _U.list([]),
      A2($List.repeat,
      m.sudoku.n,
      A2($Html.col,_U.list([]),_U.list([]))));
      var cgroups = A2($List.repeat,m.sudoku.n,cgroup);
      var row = function (r) {
         return A2($Html.tr,
         _U.list([]),
         A2($List.map,A2($Html$Lazy.lazy2,viewCell,addr),r));
      };
      var rows = A2($List.map,
      row,
      A2($Utilities.listGroupBy,
      m.sudoku.n2,
      $Array.toIndexedList(m.cells)));
      var rgroups = A2($List.map,
      $Html.tbody(_U.list([])),
      A2($Utilities.listGroupBy,m.sudoku.n,rows));
      var board = A2($Html.div,
      _U.list([$Html$Attributes.id("board")]),
      _U.list([A2($Html.table,
      _U.list([]),
      A2($Basics._op["++"],cgroups,rgroups))]));
      return A2($Html.div,
      A2($List._op["::"],$Html$Attributes.id("main"),mainClass),
      _U.list([toolbox,board,status]));
   });
   var LoadSolution = function (a) {
      return {ctor: "LoadSolution",_0: a};
   };
   ...
   var update = F2(function (act,m) {
      update: while (true) {
         var _p23 = act;
         switch (_p23.ctor)
         {case "Load": var m$ = function (_p24) {
                 return A2(makeHistory,m,initPremodel(_p24));
              }({sudoku: _p23._0
                ,fixInitialNonEmptyEntries: true
                ,showCandidates: m.showCandidates});
              return _U.update(m$,
              {isProgenitor: true,clean: true,cheated: false});
            case "LoadSolution": var load = function (sudoku) {
                 return A2(makeHistory,
                 markCheated(m),
                 A2(initWithSolution,m,sudoku));
              };
              var _p25 = _p23._0;
              switch (_p25.ctor)
              {case "NoSolution": return A2(updateStatusMessage,
                   "No solution.",
                   m);
                 case "MultipleSolutions": return A2(updateStatusMessage,
                   "Multiple solutions.",
                   load(_p25._0));
                 default: return load(_p25._0);}
            case "Clear": var _v9 = Load($Sudoku.blankSudoku(m.sudoku.n)),
              _v10 = m;
              act = _v9;
              m = _v10;
              continue update;
            case "Fix": var f = F3(function (_p26,c,sc) {
                 return $Utilities.isLeft(c) ? A2($Widgets$SudokuCell.update,
                 $Widgets$SudokuCell.ECAction($Widgets$EntryCell.SetFixed(true)),
                 sc) : sc;
              });
              return function (_p27) {
                 return markClean(A2(makeHistory,m,toPremodel(_p27)));
              }(A2(updateCellsZipped,m,f));
            case "Reset": return A2($Maybe.withDefault,m,wipeSlateClean(m));
            case "Undo": return A2($Maybe.withDefault,m,toPast(m));
            case "Redo": return A2($Maybe.withDefault,m,toFuture(m));
            case "ShowCandidates": var _p29 = _p23._0;
              var msg = _p29 ? A2($String.join,
              "\n",
              _U.list(["To remove a candidate, click on it."
                      ,"Clicking on the last candidate in a cell selects it."])) : "";
              return function (_p28) {
                 return A2(updateStatusMessage,msg,reinitCells(_p28));
              }(_U.update(m,{showCandidates: _p29}));
            case "HandleEntryClick": var _p41 = _p23._0;
              var psc = A2($Array.get,_p41,m.cells);
              var warning = "To remove, click again.";
              var cInit = F2(function (c,_p30) {
                 return A3($Widgets$SudokuCell.tryToInitWithCandidateCell,
                 c,
                 m.sudoku.n,
                 true);
              });
              var eInit = F2(function (c,sc) {
                 var _p31 = {ctor: "_Tuple2",_0: m.showCandidates,_1: sc};
                 if (_p31.ctor === "_Tuple2" && _p31._0 === false && _p31._1.ctor === "CCModel")
                 {
                       return $Widgets$SudokuCell.initWithNonFixedEntryCell(c);
                    } else {
                       return sc;
                    }
              });
              var _p32 = function () {
                 var _p33 = psc;
                 if (_p33.ctor === "Just" && _p33._0.ctor === "ECModel") {
                       var _p34 = _p33._0._0;
                       return {ctor: "_Tuple2"
                              ,_0: _U.eq(_p34.value,$Maybe.Nothing)
                              ,_1: _p34.fixed};
                    } else {
              ...
              var f = function (_p35) {
                 ...
                 return A3($Utilities.if$,
                 !_U.eq(_p37,_p41),
                 A3(updateCellZipped,m,_p37,eInit),
                 m);
              };
              var m$ = A3($Utilities.mapWithDefault,m,f,m.selected);
              var g = function (_p38) {
                 var _p39 = _p38;
                 return A3($Utilities.if$,
                 _U.eq(_p39._0,_p41),
                 $Maybe.Just({ctor: "_Tuple2"
                             ,_0: A2(update,SetUnknown(_p41),m$)
                             ,_1: ""}),
                 $Maybe.Nothing);
              };
              var _p40 = pFixed ? {ctor: "_Tuple2"
                                  ,_0: m$
                                  ,_1: ""} : pEmpty ? {ctor: "_Tuple2"
                                                      ,_0: A3(updateCellZipped,m$,_p41,cInit)
                                                      ,_1: ""} : A3($Utilities.mapExtractWithDefault,
              {ctor: "_Tuple2",_0: m$,_1: warning},
              g,
              m.selected);
              var m$$ = _p40._0;
              var msg = _p40._1;
              ...
              function (x) {
                 return {ctor: "_Tuple2",_0: _p41,_1: x};
              },
              psc)
              ,statusMessage: msg});
            case "HandleCandidateClick": var _v15 = A5($Utilities.if$,
              m.showCandidates,
              ToggleCandidate,
              SetValue,
              _p23._0,
              ...
              m = _v16;
              continue update;
            case "SetUnknown": var _p42 = _p23._0;
              var mv = A2($Maybe.andThen,
              A2($Array.get,_p42,m.sudoku.board),
              $Utilities.fromLeft);
              var ac = $Sudoku.allCandidates(m.sudoku.n);
              var sc = A3($Widgets$SudokuCell.tryToInitWithCandidateCell,
              $Utilities.Right(ac),
              m.sudoku.n,
              m.showCandidates);
              var pm = {sudoku: A3($Sudoku.setCandidates,ac,_p42,m.sudoku)
                       ,cells: A3($Array.set,_p42,sc,m.cells)};
              var f = function (v) {
                 return A3(clustersXFoldl,
                 _p42,
                 candidateUpdate($Sudoku.insert(v)),
                 pm);
              };
              var pm$ = simpleElimination(A3($Utilities.mapWithDefault,
              pm,
              f,
              mv));
              return A2(makeHistory,m,{sudoku: pm$.sudoku,cells: pm$.cells});
            case "SetValue": var _p46 = _p23._0;
              var _p45 = _p23._1;
              var maybeCandidates = function (p) {
                 return A2($Maybe.andThen,
                 A2($Array.get,p,m.sudoku.board),
                 $Utilities.fromRight);
              };
              var sc = function (_p43) {
                 return $Widgets$SudokuCell.ECModel($Widgets$EntryCell.init(_p43));
              }({value: $Maybe.Just(_p46),fix: false});
              var f = function (candidates) {
                 return A2($Sudoku.member,_p46,candidates) ? function (_p44) {
                    return A2(makeHistory,
                    m,
                    A3(clustersXFoldl,
                    _p45,
                    candidateUpdate($Sudoku.remove(_p46)),
                    _p44));
                 }({sudoku: A3($Sudoku.setValue,_p46,_p45,m.sudoku)
                   ,cells: A3($Array.set,_p45,sc,m.cells)}) : m;
              };
              return A3($Utilities.mapWithDefault,m,f,maybeCandidates(_p45));
            case "ToggleCandidate": var _p48 = _p23._0;
              var _p47 = _p23._1;
              var maybeCandidates = function (p) {
                 return A2($Maybe.andThen,
                 A2($Array.get,p,m.sudoku.board),
              ...
              var g = function (sc) {
                 return A2($Widgets$SudokuCell.update,
                 $Widgets$SudokuCell.CCAction($Widgets$CandidatesCell.ToggleEntry(_p48)),
                 sc);
              };
              var f = function (candidates) {
                 return $Sudoku.isEmpty(A2($Sudoku.toggle,
                 _p48,
                 candidates)) ? A2(update,
                 A2(SetValue,_p48,_p47),
                 m) : A2(makeHistory,
                 m,
                 {sudoku: A3($Sudoku.toggleCandidate,_p48,_p47,m.sudoku)
                 ,cells: A3($Utilities.arrayUpdate,_p47,g,m.cells)});
              };
              return A3($Sudoku.occursInClustersX,
              m.sudoku,
              _p47,
              _p48) ? m : A3($Utilities.mapWithDefault,
              m,
              f,
              maybeCandidates(_p47));
            default: return A3(updateCell,
              m,
              _p23._0,
              $Widgets$SudokuCell.update(_p23._1));}
      }
   });
   return _elm.Widgets.SudokuGame.values = {_op: _op
                                           ,Load: Load
                                           ...
                                           ,toPremodel: toPremodel
                                           ,toHistoricModel: toHistoricModel
                                           ,InitData: InitData
                                           ,init: init
                                           ,initPremodel: initPremodel
                                           ,view: view
                                           ,viewCell: viewCell
                                           ,update: update
                                           ,updateCell: updateCell
                                           ,updateCells: updateCells
                                           ,updateCellZipped: updateCellZipped
                                           ,updateCellsZipped: updateCellsZipped
                                           ,updateStatusMessage: updateStatusMessage
                                           ,markClean: markClean
                                           ,markCheated: markCheated
                                           ,makeHistory: makeHistory
                                           ,toFuture: toFuture
                                           ,toPast: toPast
                                           ,wipeSlateClean: wipeSlateClean
                                           ,tidyUp: tidyUp
                                           ,tidyUpdate: tidyUpdate
                                           ,reinitCells: reinitCells
                                           ,initWithSolution: initWithSolution
                                           ,clustersXFoldl: clustersXFoldl
                                           ,candidateUpdate: candidateUpdate
                                           ,simpleElimination: simpleElimination
                                           ,cellNotificationHandler: cellNotificationHandler};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $MVC$Application = Elm.MVC.Application.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Sudoku = Elm.Sudoku.make(_elm),
   $Utilities = Elm.Utilities.make(_elm),
   $Widgets$SudokuGame = Elm.Widgets.SudokuGame.make(_elm);
   var _op = {};
   var solutionAvailable = Elm.Native.Port.make(_elm).inboundSignal("solutionAvailable",
   "List Sudoku.SerializedSudoku",
   function (v) {
      return typeof v === "object" && v instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.map(function (v) {
         return typeof v === "object" && "n" in v && "board" in v ? {_: {}
                                                                    ...
                                                                    v.board)} : _U.badPort("an object with fields `n`, `board`",v);
      })) : _U.badPort("an array",v);
   });
   var newAvailable = Elm.Native.Port.make(_elm).inboundSignal("newAvailable",
   "Maybe.Maybe\n    Sudoku.SerializedSudoku",
   function (v) {
      return v === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v === "object" && "n" in v && "board" in v ? {_: {}
                                                                                                                                       ,n: typeof v.n === "number" && isFinite(v.n) && Math.floor(v.n) === v.n ? v.n : _U.badPort("an integer",
                                                                                                                                       v.n)
                                                                                                                                       ,board: typeof v.board === "object" && v.board instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.board.map(function (v) {
                                                                                                                                          return typeof v === "object" && v instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.map(function (v) {
                                                                                                                                       ...
                                                                                                                                       v.board)} : _U.badPort("an object with fields `n`, `board`",
      v));
   });
   var initialSudoku = Elm.Native.Port.make(_elm).inbound("initialSudoku",
   "Sudoku.SerializedSudoku",
   function (v) {
      return typeof v === "object" && "n" in v && "board" in v ? {_: {}
                                                                 ,n: typeof v.n === "number" && isFinite(v.n) && Math.floor(v.n) === v.n ? v.n : _U.badPort("an integer",
   ...
   var storedState = Elm.Native.Port.make(_elm).inbound("storedState",
   "Maybe.Maybe Bool",
   function (v) {
      return v === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v === "boolean" ? v : _U.badPort("a boolean (true or false)",
      v));
   });
   var updateExternal = F2(function (ntf,m) {
      var _p0 = ntf;
      if (_p0.ctor === "NewAvailable") {
            var g = function (x) {
               return A2($Widgets$SudokuGame.update,
               $Widgets$SudokuGame.Load($Sudoku.deserialize(x)),
               m);
            };
            return A3($Utilities.mapWithDefault,m,g,_p0._0);
         } else {
            var g = function (x) {
               return A2($Widgets$SudokuGame.update,
               $Widgets$SudokuGame.LoadSolution(x),
               m);
            };
            var _p1 = _p0._0;
            if (_p1.ctor === "::") {
                  var t = A3($Utilities.if$,
                  $List.isEmpty(_p1._1),
                  $Sudoku.Solution,
                  $Sudoku.MultipleSolutions);
                  return g(t($Sudoku.deserialize(_p1._0)));
               } else {
                  return g($Sudoku.NoSolution);
               }
         }
   });
   var SolutionAvailable = function (a) {
      return {ctor: "SolutionAvailable",_0: a};
   };
   var NewAvailable = function (a) {
      return {ctor: "NewAvailable",_0: a};
   };
   var externalEvents = _U.list([A2($Signal.map,
                                NewAvailable,
                                newAvailable)
                                ,A2($Signal.map,SolutionAvailable,solutionAvailable)]);
   var initData = {sudoku: $Sudoku.deserialize(initialSudoku)
                  ,fixInitialNonEmptyEntries: true
                  ,showCandidates: A2($Maybe.withDefault,false,storedState)};
   var mvc = {mwInitModel: $Widgets$SudokuGame.init(initData)
             ,mwView: $Widgets$SudokuGame.view
             ,mwUpdate: $Widgets$SudokuGame.update
             ,externalEvents: externalEvents
             ,updateExternal: updateExternal};
   var state = $MVC$Application.initState(mvc);
   var requestSaveState = Elm.Native.Port.make(_elm).outboundSignal("requestSaveState",
   function (v) {
      return v;
   },
   A2($Signal.map,
   function (_p2) {
      var _p3 = _p2;
      return _p3._0.showCandidates;
   },
   state));
   var requestNew = Elm.Native.Port.make(_elm).outboundSignal("requestNew",
   function (v) {
      return [];
   },
   function () {
      var f = function (_p4) {
         ...
         $Widgets$SudokuGame.RequestNew,
         _p5._1) ? $Maybe.Just({ctor: "_Tuple0"}) : $Maybe.Nothing;
      };
      return A3($Signal.filterMap,f,{ctor: "_Tuple0"},state);
   }());
   var requestSolution = Elm.Native.Port.make(_elm).outboundSignal("requestSolution",
   function (v) {
      return v.ctor === "Nothing" ? null : {n: v._0.n
                                           ,board: Elm.Native.List.make(_elm).toArray(v._0.board).map(function (v) {
   ...
   function () {
      var f = function (_p6) {
         var _p7 = _p6;
         return A2($List.member,
         $Widgets$SudokuGame.RequestSolution,
         _p7._1) ? $Maybe.Just($Maybe.Just($Sudoku.serialize(_p7._0.sudoku))) : $Maybe.Nothing;
      };
      return A3($Signal.filterMap,f,$Maybe.Nothing,state);
   }());
   var main = A2($MVC$Application.run,mvc,state);
